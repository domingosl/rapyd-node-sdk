...
module.exports = class Rapyd {
    ...
    constructor(accessKey, secretKey, env) {
        ...
        //Editing customers in Rapyd uses a POST call -_-
        this.CustomersEdit = new RestInterface(this, '/v1/customers/{0}');

        this.Hosted = {
            Collect: {
                Card: new RestInterface(this, '/v1/hosted/collect/card')
            }
        };
        ...
        this.PaymentsMethods = {
            Types: new RestInterface(this, null, '/v1/payment_methods/countries/{0}'),
            RequiredFields: new RestInterface(this, null, '/v1/payment_methods/required_fields/{0}')
        };
