...
module.exports = class Rapyd {
    ...
    constructor(accessKey, secretKey, env) {
        ...
        this.Wallets = new RestInterface(this, '/v1/user', '/v1/user/{0}');
        ...
        this.Issuing = {
            BankAccounts: new RestInterface(this, '/v1/issuing/bankaccounts')
        }
    ...
    async makeRequest(endpoint, method, payload) {
        ...
        try {
            ...
            me.events.emit('log', 'debug', "New Rapyd API request", {endpoint: this.endpoint, method: this.method, payload: this.payload});
